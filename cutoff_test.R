...
res_folder = "sym25_CD8A_LumA_B_IDC_ega" # NOTE: Please change this folder name to identify your experiments
...
gpvalue
qcut=
test<-as.data.frame(matrix(ncol=1, nrow=901))
colnames(test)[1]="padj"
test[1,1]=-log10(surv_pvalue(fit)[2])
